...
public class GUI extends JFrame {
    ...
    private JPanel contenedor;     // CardLayout para cambiar pantallas
    ...
    // Permite cambiar de pantalla desde otros paneles (login → admin/album) //
    public void mostrar(String nombrePanel) {
        cards.show(contenedor, nombrePanel);
        if ("login".equals(nombrePanel)) titulo.setText("Iniciar Sesión");
        else if ("admin".equals(nombrePanel)) titulo.setText("Panel Administrador");
        else if ("album".equals(nombrePanel)) titulo.setText("Álbum de estampas");
    }
}